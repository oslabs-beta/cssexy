...
const targetSlice = createSlice({
  ...
  reducers: {
    updateTargetSourceRegular: (state, action) => {
      ...
      console.log('\n\n');
      console.warn('targetSlice: state.targetSourceRegular: updated', state.targetSourceRegular);
    },
    updateTargetSourceInline: (state, action) => {
      ...
      console.log('\n\n');
      console.warn('targetSlice: state.targetSourceInline: updated', state.targetSourceInline);
    },
