...
function RulesRegularComp() {
  ...
  // doing this - which is reversing the order of the regularRules that we get back from cdp - seems to match the order of the rules in dev tools. Which is to say, the regular rules returned from cdp are already ordered according to specificity.
